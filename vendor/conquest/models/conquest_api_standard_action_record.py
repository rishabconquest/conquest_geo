...
class ConquestApiStandardActionRecord(object):
    ...
    def __init__(self, account=None, action_category=None, action_type=None, completed_icon_file=None, department=None, dim_rate_multiplier=None, icon_file=None, new_works=None, rehabilitation=None, request_response=None, std_action_description=None, urgency=None, _configuration=None):  # noqa: E501
