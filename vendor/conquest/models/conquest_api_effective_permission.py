...
class ConquestApiEffectivePermission(object):
    ...
    def __init__(self, account_id=None, effective_permission=None, facility_permission=None, object_key=None, object_permisions=None, type_permisions=None, _configuration=None):  # noqa: E501
