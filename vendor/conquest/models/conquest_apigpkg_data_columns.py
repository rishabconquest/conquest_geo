...
class ConquestApigpkgDataColumns(object):
    ...
    def __init__(self, column_name=None, constraint_name=None, description=None, mime_type=None, name=None, table_name=None, title=None, _configuration=None):  # noqa: E501
