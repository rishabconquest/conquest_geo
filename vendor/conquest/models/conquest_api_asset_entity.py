...
class ConquestApiAssetEntity(object):
    ...
    def __init__(self, action_permission=None, adding_date=None, adding_user=None, asset_id=None, attribute_id=None, defect_permission=None, edit_date=None, editor=None, inspection_id=None, map_style=None, parent_id=None, permission=None, record=None, replaced_asset=None, retirement_date=None, retirement_reason=None, retirement_user=None, split_asset_id=None, status=None, lock=None, _configuration=None):  # noqa: E501
