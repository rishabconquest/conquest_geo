...
class ConquestApiApplyStandardActionOverwriteOptions(object):
    ...
    def __init__(self, account=None, action_category=None, action_description=None, action_notes=None, action_type=None, assign_to=None, urgency=None, _configuration=None):  # noqa: E501
