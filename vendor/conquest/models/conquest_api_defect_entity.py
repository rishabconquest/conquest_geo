...
class ConquestApiDefectEntity(object):
    ...
    def __init__(self, action_id=None, asset_id=None, attribute_id=None, completion_date=None, defect_id=None, edit_date=None, editor=None, inspection_id=None, map_style=None, permission=None, record=None, response_date=None, severity_score=None, sys_user_hierarchy1=None, lock=None, _configuration=None):  # noqa: E501
