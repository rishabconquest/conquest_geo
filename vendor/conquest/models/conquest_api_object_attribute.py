...
class ConquestApiObjectAttribute(object):
    ...
    def __init__(self, caption=None, foreign_object_path=None, foreign_object_type=None, nullable=None, object_attribute_kind=None, object_type=None, parameter=None, parameter_type=None, path=None, primary_key=None, value_type=None, _configuration=None):  # noqa: E501
