...
class ConquestApiFindQuery(object):
    ...
    def __init__(self, context=None, criteria=None, field_names=None, filter_id=None, limit=None, map_view_id=None, parameter_object_key=None, parameter_object_key2=None, without_default_criteria=None, x_include_coordinates=None, x_include_related_contexts=None, _configuration=None):  # noqa: E501
