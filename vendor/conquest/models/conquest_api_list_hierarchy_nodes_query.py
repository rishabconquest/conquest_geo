...
class ConquestApiListHierarchyNodesQuery(object):
    ...
    def __init__(self, include_ancestors=None, include_children=None, include_descendents=None, include_siblings=None, include_sub_items=None, object_key=None, _configuration=None):  # noqa: E501
