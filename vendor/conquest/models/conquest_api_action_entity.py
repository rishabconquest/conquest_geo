...
class ConquestApiActionEntity(object):
    ...
    def __init__(self, action_id=None, approval_requested=None, asset_id=None, attribute_id=None, completed=None, created_by=None, edit_date=None, editor=None, issue_date=None, map_style=None, permission=None, previous_action=None, record=None, reference_id=None, type_id=None, lock=None, _configuration=None):  # noqa: E501
