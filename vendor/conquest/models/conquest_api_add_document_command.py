...
class ConquestApiAddDocumentCommand(object):
    ...
    def __init__(self, address=None, content_length=None, content_type=None, create_time=None, document_description=None, hashes=None, link_existing_document=None, object_key=None, prefix=None, _configuration=None):  # noqa: E501
    ...
    def address(self):
        ...
        Address is a URI with a supported scheme (blob://, file://, https://, conquest://, trim://).  Addresses tell the server in what location a document should be put. Use ListDocumentLocationsQuery to list available locations.  Locations are pre-defined and are identified by a prefix like \"{scheme}://{location-name}\".  The default location, known as the \"System Document Directory\" is  - \"file://conquest_documents/\" for site installations  - \"blob://default/\" for cloud installations (the location name may differ).  When choosing an address, prefix it with a known location, followed by a relative path. For example:       \"blob://default/Assets/1/receipt.txt\"  After a successful upload, reference this document using both the ObjectKey and the returned Document.DocumentID when using the download endpoint. For example:       \"/download/document?object_type=...&object_id=...&document_id=...\"  This endpoint may redirect (provide an address in the Location header) you to a download.  # noqa: E501
    ...
    def object_key(self):
        ...
        ObjectKey (please reference the ObjectKey documentation).  # noqa: E501
    ...
    @property
    def prefix(self):
        """Gets the prefix of this ConquestApiAddDocumentCommand.  # noqa: E501


        :return: The prefix of this ConquestApiAddDocumentCommand.  # noqa: E501
        :rtype: str
        """
        return self._prefix
    ...
    def prefix(self, prefix):
        """Sets the prefix of this ConquestApiAddDocumentCommand.


        :param prefix: The prefix of this ConquestApiAddDocumentCommand.  # noqa: E501
        :type: str
        """
