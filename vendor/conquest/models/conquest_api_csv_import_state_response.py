...
class ConquestApiCsvImportStateResponse(object):
    ...
    def __init__(self, created=None, created_by=None, description=None, error=None, last_updated=None, process_id=None, status=None, status_description=None, task_progress=None, title=None, total_work=None, work_done=None, job_key=None, _configuration=None):  # noqa: E501
