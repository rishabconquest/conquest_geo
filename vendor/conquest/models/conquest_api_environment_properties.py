...
class ConquestApiEnvironmentProperties(object):
    ...
    def __init__(self, data_directory=None, data_directory_token=None, hostname=None, uploads_directory=None, uploads_directory_token=None, legacy_document_directories=None, _configuration=None):  # noqa: E501
