...
class ConquestApiGeoPackageTableDescription(object):
    ...
    def __init__(self, column_infos=None, contents=None, data_columns=None, geometry_column=None, geometry_columns=None, key_column_option=None, object_id_column=None, object_type=None, srs_supported=None, table_name=None, _configuration=None):  # noqa: E501
    ...
    def geometry_column(self):
        ...
        GeometryColumn is the geometry column that will be used. There can only be one of these per table.  # noqa: E501
    ...
    def object_id_column(self):
        ...
        This is identified by either the KeyColumnOption otherwise a it will be inferred based on a naming convention for Conquest IDs like asset_id or by annotated columns in DataColumns  # noqa: E501
    ...
    def object_type(self):
        ...
        ObjectType that will be used to key data to the Conquest Object.  This is identified by either the KeyColumnOption otherwise a it will be inferred based on a naming convention for Conquest IDs like asset_id or by annotated columns in DataColumns  # noqa: E501
