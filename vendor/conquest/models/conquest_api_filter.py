...
class ConquestApiFilter(object):
    ...
    def __init__(self, context=None, description=None, filter_id=None, filter_name=None, map_view_id=None, system=None, user_views=None, usr=None, _configuration=None):  # noqa: E501
