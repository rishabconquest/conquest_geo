...
class ConquestApigpkgContents(object):
    ...
    def __init__(self, data_type=None, description=None, identifier=None, last_change=None, max_x=None, max_y=None, min_x=None, min_y=None, srs_id=None, table_name=None):  # noqa: E501
