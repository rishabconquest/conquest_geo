...
class ConquestApiAttributeSetField(object):
    ...
    def __init__(self, caption=None, dimension_value=None, field_name=None, hierarchy_value=None, list_value=None, notes=None, order=None, required=None, simple_value=None, weighted_value=None):  # noqa: E501
