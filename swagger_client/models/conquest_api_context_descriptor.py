...
class ConquestApiContextDescriptor(object):
    ...
    def __init__(self, context=None, parameter_object_type=None, parameter_object_type2=None, predefined_context_criteria=None, result_object_type=None, system=None):  # noqa: E501
