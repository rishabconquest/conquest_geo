...
from .controllers import AssetCreationController
...
class ConquestGeo:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ConquestGeo', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/conquest_geo/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'New asset'),
            callback=self.run,
